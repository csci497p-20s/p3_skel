cd ../input
wget https://facultyweb.cs.wwu.edu/~wehrwes/courses/csci497p_20s/p3/tentacle.zip
unzip tentacle.zip
cd ../data

cd ../test_materials
wget https://facultyweb.cs.wwu.edu/~wehrwes/courses/csci497p_20s/p3/fabrics_normalized.npy
cd ../data
